...
$_ADDONLANG['client_table_records_emptytable'] = "<h3>Add <button type=\"button\" class=\"btn btn-success btn-xs\" data-toggle=\"modal\" data-target=\"#dialog_addRecord\" title=\"Add Record\"><span class=\"fas fa-plus\" aria-hidden=\"true\"></span></button> the first record!</h3>";
...
$_ADDONLANG['global_status_default'] = "Default";
...
// Modals
$_ADDONLANG['global_text_zone_save_title'] = "Do you want to save changes?";
$_ADDONLANG['global_text_zone_save_desc'] = "Press \"Save Changes\" to save any changes you have made.";
...
$_ADDONLANG['global_validation_LUA_PARTS_MISSING'] = "LUA records must have: &lt;record type&gt; &lt;lua rule&gt;.";
$_ADDONLANG['global_validation_LUA_PART_0_INVALID'] = "The provided record type: '%s' is not valid and cannot be used.";
