...
$_ADDONLANG['global_validation_LUA_PARTS_MISSING'] = "Los registros LUA deben tener: &lt;tipo de registro&gt; &lt;regla lua&gt;.";
$_ADDONLANG['global_validation_LUA_PART_0_INVALID'] = "El tipo de registro proporcionado: '%s' no es válido y no se puede utilizar.";
$_ADDONLANG['global_validation_LUA_PART_1_INVALID'] = "Ocurrió un error de sintaxis. Las reglas de LUA deben estar entre comillas (\") o entre paréntesis.";
